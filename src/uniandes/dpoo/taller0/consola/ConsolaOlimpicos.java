...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar país del cual pertenece un atleta");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	/**
	 * Le muestra el usuario el pais al que pertenece un atleta
	 */
	private void ejecutarPaisAtleta()
	{
		System.out.println("\n" + "País al que pertenece un atleta" + "\n");
		String name = input("Por favor ingrese el nombre del atleta");
		String Pais = calculadora.paisDelAtleta(name);
		System.out.println("El país del cual pertenece el atleta "+name+" es : "+Pais);
	}
...
/*[NOTAS] 
* (Map<String, List<Atleta>>) define que va a ser la variable "Atletas" y si miras lo que hace calculadora.atletasPorAnio, ves
* que lo que retorna es el mapa con nombre del evento de llave y valor la lista de atletas
*/
